...
import com.inducesmile.weatherapp.adapters.CustomArrayAdapter;
import com.inducesmile.weatherapp.database.DatabaseQuery;
import com.inducesmile.weatherapp.entity.ListJsonObject;
...
public class AddLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addLocation =  findViewById(R.id.new_location);
        ...
        addLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent listLocationIntent = new Intent(getApplicationContext(), ListLocationActivity.class);
                startActivity(listLocationIntent);
            }
        });
    }
